...
echo -e "\n${BLUE}╔═════{ KeePass database file:${XX}"
    find / -name *.kdbx -o -name *.kdb -type f 2>/dev/null | xargs ls -la --color=always 2>/dev/null
        echo -e "\t╔════════════════════════════════════════════════════════════════════════════════════════════╗"
...
echo -e "\n${BLUE}╔═════{ Wireshark files:${XX}"
    find / -name *.pcapng -o -name *.libpcap -type f 2>/dev/null | xargs ls -la --color=always | grep -v "/usr/"
...
echo -e "\n${BLUE}╔═════{ OpenVPN Files:${XX}"
    find / -iname *.ovpn -type f 2>/dev/null | xargs ls -la 2>/dev/null
echo -e "${RED} \t\t╔════════════════════════════════════════════════════════════════════════════════════════════════════════╗${XX}"
